...
{ before(grammarAccess.getFirewallAccess().getReglasReglaParserRuleCall_0()); }
	ruleRegla{ after(grammarAccess.getFirewallAccess().getReglasReglaParserRuleCall_0()); }
)
...
{ before(grammarAccess.getCondicionPuertoAccess().getNameINTTerminalRuleCall_1_0()); }
	RULE_INT{ after(grammarAccess.getCondicionPuertoAccess().getNameINTTerminalRuleCall_1_0()); }
)
